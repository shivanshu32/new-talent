export default function Hero ()  {
  ...
  <div class="absolute inset-0">
    <img src="/hero2.png" alt="Background Image" class="object-cover ml-32 object-center" />
  ...
  <img src="/ntmgslogo.png" alt="Background Image" />
  ...
  <br /><br />
    ...
    <a href="#" class="bg-black text-gray-100 hover:bg-gray-700 py-2 px-6 text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">Enroll Here</a>
  </div>
  </div>
</div>
