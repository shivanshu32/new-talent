  ...
  return (
    <>
      <div className="relative overflow-y-hidden">
        <img src="/trd.jpg" className="absolute h-full object-cover object-center w-full" />
       
        <div className="absolute bg-gray-900 h-full w-full opacity-25" />
        <div className="mx-auto container lg:px-0 px-4 h-full relative">
         
       
          <div className="flex flex-col items-center justify-end lg:pb-28 pb-14 pt-96">
            
          <div className="xl:w-1/2 sm:w-1/2 w-full 2xl:w-1/5 flex flex-col items-center   md:py-12  bg-gradient-to-r from-gray-700 to-gray-500 rounded-lg">
