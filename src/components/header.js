                            ...
                            <div className="flex w-full sm:w-auto items-center sm:items-stretch justify-end sm:justify-start">
                                <div className="flex items-center">
                                  <img  className="h-16" src="/newtalentlogo.png" alt="logo" />
                                    ...
                                    <h2 className="hidden sm:block text-base text-gray-700 font-bold leading-normal pl-3">New Talent</h2> */}
                                </div>
                            </div>
                            <div className="flex">
                                <div className="hidden xl:flex md:mr-6 xl:mr-16">
                                    {/* <a href="javascript: void(0)" className="flex px-5 items-center py-6 text-sm leading-5 text-white hover:text-gray-300 focus:text-gray-300 focus:outline-none transition duration-150 ease-in-out"> */}
                                       
                                    <Link to="/" className="flex px-5 items-center py-6 text-sm leading-5 text-white hover:text-gray-300 focus:text-gray-300 focus:outline-none transition duration-150 ease-in-out">   Home </Link>
                                    {/* </a> */}
                                    {/* <a href="javascript: void(0)" className="flex px-5 items-center py-6 text-sm leading-5 text-white hover:text-gray-300 focus:text-gray-300 focus:outline-none transition duration-150 ease-in-out"> */}
                                       
                                    <Link to="/about" className="flex px-5 items-center py-6 text-sm leading-5 text-white hover:text-gray-300 focus:text-gray-300 focus:outline-none transition duration-150 ease-in-out"> About </Link>
                                    {/* </a> */}
                                    {/* <a href="javascript: void(0)" className="flex px-5 items-center py-6 text-sm leading-5 text-white hover:text-gray-300 focus:text-gray-300 focus:outline-none transition duration-150 ease-in-out"> */}
                                      <Link to="/tarun-rajput" className="flex px-5 items-center py-6 text-sm leading-5 text-white hover:text-gray-300 focus:text-gray-300 focus:outline-none transition duration-150 ease-in-out">
                                        Tarun Rajput
                                        </Link>
                                    {/* </a> */}
                                    {/* <a href="javascript: void(0)" className="flex px-5 items-center py-6 text-sm leading-5 text-white hover:text-gray-300 focus:text-gray-300 focus:outline-none transition duration-150 ease-in-out">
...
{/* test start */}
<li className="flex px-5 items-center py-6 text-sm leading-5 text-white hover:text-gray-300 focus:text-gray-300 focus:outline-none transition duration-150 ease-in-out  tracking-normal relative z-20"  onMouseEnter={()=> setProduct(!product)}> {product && (
                            <ul className="bg-white shadow rounded py-1 w-36 left-0 mt-16 -ml-4 absolute top-0">
                                <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-black hover:text-white px-3 font-normal"><Link to="/pageant-training">Pageant Training</Link></li>
                                <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-black hover:text-white px-3 font-normal"><Link to="/model-training">Model Training</Link></li>
                                <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-black hover:text-white px-3 font-normal"><Link to="/portfolio">Portfolio</Link></li>
                            </ul>
                            )} Programs
                            <span className="ml-2">
...
{/* test ends */}
                                    ...
                                    {/* <a href="javascript: void(0)" className="flex px-5 items-center py-6 text-sm leading-5 text-white hover:text-gray-300 focus:text-gray-300 focus:outline-none transition duration-150 ease-in-out"> */}
                                       <Link to="/contact" className="flex px-5 items-center py-6 text-sm leading-5 text-white hover:text-gray-300 focus:text-gray-300 focus:outline-none transition duration-150 ease-in-out">
                                       Contact
                                       </Link>
